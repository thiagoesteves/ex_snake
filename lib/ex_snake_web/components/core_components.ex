defmodule ExSnakeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExSnakeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExSnakeWeb.Gettext, "errors", msg, opts)
    end
  end
